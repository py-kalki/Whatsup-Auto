    ...
    <div className="py-14 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 flex flex-col gap-10">
          ...
          {/* 4. AI Brain Setup */}
          <section id="ai-brain" className="p-6 sm:p-8 rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/90 shadow-sm scroll-mt-24 flex flex-col gap-5">
            <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-white flex items-center gap-3">
              ...
              <span>4. AI Brain & Persona Setup (Zero API Keys)</span>
            </h2>

            <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed font-normal">
              WhatsAuto uses an intelligent 3-tier fallback architecture to reply to customers intelligently.
            </p>

            <div className="space-y-3">
              <div className="p-4.5 rounded-2xl bg-zinc-50 dark:bg-zinc-950/60 border border-zinc-200 dark:border-zinc-800">
                <div className="flex items-center gap-2 font-bold text-xs text-zinc-900 dark:text-white mb-1.5">
                  <Zap className="w-4 h-4 text-amber-500" />
                  <span>Inbuilt Antigravity AI (100% Free & Local)</span>
                </div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  Powered natively by your local system. Requires zero API keys, zero credit cards, and zero monthly subscription costs.
                </p>
              </div>
              ...
              <div className="p-4.5 rounded-2xl bg-zinc-50 dark:bg-zinc-950/60 border border-zinc-200 dark:border-zinc-800">
                <div className="flex items-center gap-2 font-bold text-xs text-zinc-900 dark:text-white mb-1.5">
                  ...
                  <span>Custom Business Persona & FAQs</span>
                </div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  In the <strong>AI Brain</strong> tab of the dashboard, enter your company name, services, pricing policies, and FAQs. The AI answers customer inquiries using your exact tone and knowledge base!
                </p>
              </div>
              ...
              <div className="p-4.5 rounded-2xl bg-zinc-50 dark:bg-zinc-950/60 border border-zinc-200 dark:border-zinc-800">
                <div className="flex items-center gap-2 font-bold text-xs text-zinc-900 dark:text-white mb-1.5">
                  ...
                  <span>Optional: Google Gemini 2.0 or OpenAI GPT-4o</span>
                </div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  Want to use ultra-fast cloud models? Simply paste your Gemini or OpenAI API key into the dashboard settings or <code>.env</code> file.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between text-xs font-semibold text-zinc-500 mb-1.5">
                  ...
                  <button
                    onClick={() => handleCopyCode('dev1', 'git clone https://github.com/py-kalki/whatsapp-automation.git\ncd whatsapp-automation\nnpm install')}
